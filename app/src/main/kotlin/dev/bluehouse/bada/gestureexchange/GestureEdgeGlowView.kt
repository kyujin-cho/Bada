...
/**
 * Bada-owned edge-light treatment for Tap to Share: a symmetric top-centre
 * sweep, blurred halo, crisp comet, and deterministic time/easing animation.
 * It follows the interaction's open/connected states without copying assets.
 */
@Suppress("MagicNumber") // Local visual geometry, colour, and easing constants are intentionally literal.
private class GestureEdgeGlowView(
    ...
    private companion object {
        private const val GLOW_COLOR = 0xFF0F62FE.toInt()
        private const val PARTIAL_FRACTION = 0.34f
        private const val OPEN_DELAY_MS = 250L
        private const val OPEN_DURATION_MS = 900L
        private const val HEAD_DURATION_MS = 360L
        private const val TAIL_DURATION_MS = 720L
