...
import dev.bluehouse.libredrop.protocol.crypto.securemessage.SequencedOfflineFrame
import dev.bluehouse.libredrop.protocol.medium.Medium
import dev.bluehouse.libredrop.protocol.medium.MediumRegistry
import dev.bluehouse.libredrop.protocol.medium.PreparedUpgradeSelection
import dev.bluehouse.libredrop.protocol.medium.UpgradePathCredentials
import dev.bluehouse.libredrop.protocol.medium.UpgradedTransport
import dev.bluehouse.libredrop.protocol.medium.asFramedConnection
 ...
 * [dev.bluehouse.libredrop.protocol.medium.MediumProvider] to prepare /
