 ...
 *    has already been closed by [dev.bluehouse.libredrop.protocol.payload.PayloadAssembler].
...
public sealed interface ReceivedItem {
     ...
     *
     * The [dev.bluehouse.libredrop.protocol.payload.FileDestinationFactory]
