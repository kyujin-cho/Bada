...
import dev.bluehouse.libredrop.protocol.sharing.IntroductionFrame
 ...
 * enters [dev.bluehouse.libredrop.protocol.sharing.InboundSharingState.WaitingForUserConsent].
 ...
 *   `authString` via [dev.bluehouse.libredrop.protocol.crypto.pin.PinDerivation.deriveFourDigitPin].
...
public data class TransferMetadata(
    ...
    public companion object {
         ...
         *   [dev.bluehouse.libredrop.protocol.sharing.SharingFsmEffect.IntroductionReceived].
