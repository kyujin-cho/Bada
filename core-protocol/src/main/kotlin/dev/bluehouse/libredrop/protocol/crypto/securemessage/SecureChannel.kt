...
import dev.bluehouse.libredrop.protocol.crypto.D2DSessionKeys
import dev.bluehouse.libredrop.protocol.crypto.DirectionalKeys
 ...
 *   [dev.bluehouse.libredrop.protocol.crypto.D2DKeyDerivation.derive].
...
public class SecureChannel internal constructor(
     ...
     *   [dev.bluehouse.libredrop.protocol.transport.EndOfFrameStream] when
