 ...
 */
package dev.bluehouse.libredrop.protocol.crypto.securemessage
...
public object SecureMessageCodec {
     ...
     *   from [dev.bluehouse.libredrop.protocol.crypto.DirectionalKeys]).
     ...
     *   [dev.bluehouse.libredrop.protocol.transport.FramedConnection.sendFrame].
     ...
     *   [dev.bluehouse.libredrop.protocol.transport.FramedConnection.receiveFrame]).
     * @param decryptKey 32-byte AES-256 key (the local "receive" encrypt
     *   key from [dev.bluehouse.libredrop.protocol.crypto.DirectionalKeys]).
