...
class HmacComparisonAuditTest {
    ...
    private fun mainSourceRoot(): File {
        ...
        repeat(MAX_PARENT_HOPS) {
            val candidate = dir?.resolve("src/main/kotlin/dev/bluehouse/libredrop/protocol")
    ...
    private fun readSource(relativeWithinPackage: String): String {
        val file = File(mainSourceRoot(), "dev/bluehouse/libredrop/protocol/$relativeWithinPackage")
