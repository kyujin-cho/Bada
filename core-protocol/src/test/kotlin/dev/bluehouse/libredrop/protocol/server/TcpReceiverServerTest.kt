 ...
 */
package dev.bluehouse.libredrop.protocol.server
 ...
 * deliberately do not pair against [dev.bluehouse.libredrop.protocol.connection.InboundConnection]
...
class TcpReceiverServerTest {
     ...
     * sender against it via [dev.bluehouse.libredrop.protocol.connection.OutboundConnection]
