...
import dev.bluehouse.libredrop.discovery.aware.WifiAwareMediumProvider
import dev.bluehouse.libredrop.discovery.wifi.hotspot.WifiHotspotMediumProviderFactory
import dev.bluehouse.libredrop.protocol.medium.MediumLadder
import dev.bluehouse.libredrop.protocol.medium.MediumProvider
...
public object MediumRegistries {
    ...
    private object WifiLanProvider : MediumProvider {
        override val medium: dev.bluehouse.libredrop.protocol.medium.Medium =
            dev.bluehouse.libredrop.protocol.medium.Medium.WIFI_LAN
