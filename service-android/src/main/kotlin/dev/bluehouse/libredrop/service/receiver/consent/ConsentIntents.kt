 ...
 *    [dev.bluehouse.libredrop.protocol.server.InboundConnectionCompletion.connectionId]).
 *
...
public object ConsentIntents {
    ...
    public const val ACTION_ACCEPT: String = "dev.bluehouse.libredrop.consent.ACCEPT"

    /** Broadcast action fired when the user taps the notification's "Reject" action. */
    public const val ACTION_REJECT: String = "dev.bluehouse.libredrop.consent.REJECT"
     ...
     * [dev.bluehouse.libredrop.protocol.connection.InboundConnection.cancel]
     * rather than `submitUserConsent`.
     */
    public const val ACTION_CANCEL_TRANSFER: String = "dev.bluehouse.libredrop.consent.CANCEL_TRANSFER"
     ...
     */
    public const val ACTION_SHOW_CONSENT: String = "dev.bluehouse.libredrop.consent.SHOW"
